...
namespace H2ZExtractor
{
    class Tools
    {
        public static int CalcChecksum(byte[] buffer, int buffer_size)
        {
            long v9 = 0;
            int pos = 0;
            ...
            if (a3 > a5)
            {
                v8 = a5 & unchecked((int)0xFFFFFFFC);
                v7 = a3 / (a5 & unchecked((int)0xFFFFFFFC));
                v16 = a3 & 3;
                v17 = a3 - (a5 & unchecked((int)0xFFFFFFFC)) * v7 - v16;
            }
            else
            {
                v7 = 0;
                v16 = a3 & 3;
                v17 = a3 & unchecked((int)0xFFFFFFFC);
                v8 = 0;
            }
